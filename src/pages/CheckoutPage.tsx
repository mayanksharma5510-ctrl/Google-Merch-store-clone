  ...
  if (cart.length === 0 && !confirmedOrder) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 text-center space-y-4">
        <h2 className="text-xl font-extrabold text-[#111827]">Your bag is empty</h2>
        <p className="text-xs text-[#6B7280]">Add items to cart before proceeding to checkout.</p>
        <button
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="flex items-center justify-between border-b border-gray-200 pb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-extrabold text-[#111827]">Google Secure One-Page Checkout</h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <form onSubmit={handlePlaceOrder} className="lg:col-span-7 space-y-6">
          ...
          <div className="p-5 bg-blue-50/70 border border-blue-100 rounded-[24px] flex items-center justify-between">
            <div>
          ...
          <div className="p-6 bg-white rounded-[32px] border border-gray-100 shadow-xs space-y-4">
            <h3 className="text-xs font-extrabold text-[#111827] uppercase tracking-wider border-b border-gray-100 pb-3">
              1. Shipping Address
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div className="space-y-1 sm:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-full bg-gray-50 border border-gray-200 focus:outline-none focus:border-[#2563EB] font-semibold text-[#111827]"
                />
              </div>
              ...
              <div className="space-y-1 sm:col-span-2">
                <label className="font-bold text-[#111827]">Street Address *</label>
                <input
                  type="text"
                  required
              ...
              <div className="space-y-1">
                <label className="font-bold text-[#111827]">City *</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-1">
                  <label className="font-bold text-[#111827]">State *</label>
                  <input
                    type="text"
                    required
                    placeholder="CA"
                ...
                <div className="space-y-1">
                  <label className="font-bold text-[#111827]">Postal Code *</label>
                  <input
                    type="text"
                    required
                    placeholder="94043"
          ...
          {/* Shipping Method */}
          <div className="p-6 bg-white rounded-[32px] border border-gray-100 shadow-xs space-y-3">
            <h3 className="text-xs font-extrabold text-[#111827] uppercase tracking-wider border-b border-gray-100 pb-3">
              2. Delivery Method
            </h3>
            ...
            <div className="space-y-2 text-xs">
              <label
                ...
                className={`p-4 rounded-2xl border flex items-center justify-between cursor-pointer transition-all ${
                  shippingMethod === 'express'
                    ? 'border-[#2563EB] bg-blue-50/50 text-[#111827] font-bold ring-2 ring-blue-100'
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="font-bold block text-[#111827]">Express 2-Day Delivery</span>
                    <span className="text-[11px] text-[#6B7280]">Delivered in 2 business days</span>
                  </div>
                </div>
                <span className="font-extrabold text-[#2563EB]">FREE</span>
              </label>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="font-bold block text-[#111827]">Overnight Priority Express</span>
                    <span className="text-[11px] text-[#6B7280]">Delivered tomorrow before 10:30 AM</span>
                  </div>
                </div>
                <span className="font-extrabold text-[#111827]">$14.99</span>
              </label>
            </div>
          </div>
          ...
          <div className="p-6 bg-white rounded-[32px] border border-gray-100 shadow-xs space-y-4">
            ...
            {paymentMethod === 'card' && (
              <div className="space-y-3 pt-2 text-xs border-t border-gray-100">
                <div className="space-y-1">
                  <label className="font-bold text-[#111827]">Card Number</label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    <label className="font-bold text-[#111827]">Expiry</label>
                    <input
                      type="text"
                      placeholder="MM/YY"
                      value={cardExp}
                  ...
                  <div className="space-y-1">
                    <label className="font-bold text-[#111827]">CVC</label>
                    <input
                      type="text"
                      placeholder="123"
                      value={cardCvc}
          ...
          <button
            ...
            className="w-full py-4 px-6 bg-[#2563EB] hover:bg-blue-700 text-white font-extrabold text-sm rounded-full shadow-xs flex items-center justify-center gap-2 transition-all cursor-pointer"
          >
            {isProcessing ? (
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="p-6 bg-white rounded-[32px] border border-gray-100 shadow-xs space-y-4 sticky top-24">
              ...
              {cart.map((item) => (
                <div key={item.id} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0 text-xs">
                    <h4 className="font-bold text-[#111827] truncate">{item.product.name}</h4>
            ...
            <div className="space-y-2 text-xs text-[#6B7280] pt-3 border-t border-gray-100">
              ...
              <div className="flex justify-between">
                <span>Shipping</span>
                <span className="font-bold text-[#111827]">FREE</span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="p-3.5 bg-gray-50 rounded-2xl space-y-1 text-[11px] text-[#6B7280]">
        ...
        <AnimatePresence>
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
            ...
            <motion.div
              ...
              className="relative w-full max-w-lg bg-white rounded-[32px] shadow-2xl p-6 sm:p-8 space-y-6 z-10 text-center my-8 border border-gray-100"
            >
              ...
              <div>
                ...
                <p className="text-xs text-[#6B7280] mt-1">
                  Confirmation receipt sent to <strong className="text-[#111827]">{confirmedOrder.shippingAddress.email}</strong>
                </p>
              </div>

              {/* Receipt Details Box */}
              <div className="p-5 bg-gray-50 rounded-[24px] border border-gray-100 text-left space-y-2 text-xs">
                <div className="flex justify-between border-b border-gray-200 pb-2">
                  <span className="text-[#6B7280]">Order Reference:</span>
                  <strong className="text-[#111827]">{confirmedOrder.id}</strong>
                </div>
                <div className="flex justify-between border-b border-gray-200 pb-2">
                  <span className="text-[#6B7280]">Tracking Number:</span>
                  <strong className="text-[#2563EB]">{confirmedOrder.trackingNumber}</strong>
                </div>
                <div className="flex justify-between border-b border-gray-200 pb-2">
                  <span className="text-[#6B7280]">Est. Delivery:</span>
                  <strong className="text-emerald-700">{confirmedOrder.estimatedDelivery}</strong>
                </div>
                <div className="flex justify-between pt-1">
                  <span className="font-bold text-[#111827]">Total Charged:</span>
                  <strong className="text-base font-extrabold text-[#111827]">${confirmedOrder.total.toFixed(2)}</strong>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="py-3.5 px-6 bg-gray-100 hover:bg-gray-200 text-[#111827] font-bold text-xs rounded-full flex items-center justify-center gap-1.5 cursor-pointer"
                >
