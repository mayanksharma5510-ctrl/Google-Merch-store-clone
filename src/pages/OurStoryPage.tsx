...
export const OurStoryPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
      ...
      >
        <div className="p-8 bg-white dark:bg-gray-900 rounded-[32px] border border-gray-200/80 dark:border-gray-800 shadow-xs space-y-4">
          <div className="w-12 h-12 bg-blue-50 dark:bg-blue-950/80 text-[#2563EB] dark:text-blue-400 rounded-2xl flex items-center justify-center font-bold">
        ...
        <div className="p-8 bg-white dark:bg-gray-900 rounded-[32px] border border-gray-200/80 dark:border-gray-800 shadow-xs space-y-4">
          <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-950/80 text-emerald-600 dark:text-emerald-400 rounded-2xl flex items-center justify-center font-bold">
        ...
        <div className="p-8 bg-white dark:bg-gray-900 rounded-[32px] border border-gray-200/80 dark:border-gray-800 shadow-xs space-y-4">
          <div className="w-12 h-12 bg-indigo-50 dark:bg-indigo-950/80 text-indigo-600 dark:text-indigo-400 rounded-2xl flex items-center justify-center font-bold">
      ...
      <section className="bg-gradient-to-br from-[#111827] to-gray-900 rounded-[36px] p-8 sm:p-14 text-white grid grid-cols-1 lg:grid-cols-2 gap-10 items-center border border-gray-800">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6 pt-2 border-t border-gray-800">
            <div>
              <span className="text-3xl font-black text-blue-400 block">500K+</span>
              <span className="text-xs text-gray-400">Creators Geared Up</span>
            </div>
            <div>
              <span className="text-3xl font-black text-emerald-400 block">100%</span>
              <span className="text-xs text-gray-400">Carbon Neutral Shipping</span>
            </div>
          </div>
        </div>

        <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-700 aspect-4/3">
          <img
