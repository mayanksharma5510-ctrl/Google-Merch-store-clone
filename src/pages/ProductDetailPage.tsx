  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-10 pb-28 sm:pb-12">
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 text-xs font-bold text-[#6B7280] dark:text-gray-400 hover:text-[#111827] dark:hover:text-white transition-colors cursor-pointer"
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="relative aspect-square sm:aspect-4/3 lg:aspect-square w-full min-h-[380px] sm:min-h-[480px] lg:min-h-[560px] bg-white dark:bg-gray-900 rounded-[32px] overflow-hidden border border-gray-200/80 dark:border-gray-800 shadow-sm group">
            <img
            ...
            <button
              ...
              className={`absolute top-4 right-4 p-3 rounded-full transition-all shadow-md ${
                inWishlist
                  ...
                  : 'bg-white/90 dark:bg-gray-800/90 backdrop-blur-md text-[#6B7280] dark:text-gray-300 hover:text-[#111827] dark:hover:text-white'
              }`}
              aria-label="Wishlist"
            >
            ...
            {selectedProduct.badge && (
              <span className="absolute top-4 left-4 px-3.5 py-1.5 bg-[#111827] dark:bg-blue-600 text-white font-extrabold text-[11px] uppercase tracking-wider rounded-full shadow-md">
                {selectedProduct.badge}
              </span>
            )}
          </div>
              ...
              {selectedProduct.images.map((img, idx) => (
                <button
                  ...
                  className={`w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden border-2 transition-all shrink-0 cursor-pointer ${
                    activeImgIdx === idx
                      ? 'border-[#2563EB] ring-4 ring-blue-100 dark:ring-blue-900 scale-102 shadow-sm'
        ...
        <div className="lg:col-span-5 space-y-5">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="text-[10px] font-extrabold uppercase tracking-wider px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-950/60 text-[#2563EB] dark:text-blue-400">
                {selectedProduct.category}
              </span>
              {selectedProduct.stockLeft && (
                <span className="text-[10px] font-extrabold uppercase tracking-wider text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/60 border border-red-200/80 dark:border-red-900/50 px-2.5 py-1 rounded-full flex items-center gap-1 animate-pulse">
            ...
            <p className="text-xs sm:text-sm font-medium text-[#6B7280] dark:text-gray-400 mt-1">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-3">
              ...
              {selectedProduct.originalPrice && (
                <>
                  <span className="text-base text-[#6B7280] dark:text-gray-400 line-through font-semibold">
            ...
            <div className="mt-3 p-3.5 bg-blue-50/60 dark:bg-blue-950/40 rounded-2xl border border-blue-100 dark:border-blue-900/50 text-xs text-[#111827] dark:text-gray-200 space-y-2">
          ...
          {selectedProduct.colors.length > 0 && (
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#111827] dark:text-gray-200 block">
                  ...
                  <button
                    ...
                    className={`px-3.5 py-1.5 rounded-full text-xs font-bold border flex items-center gap-2 transition-all cursor-pointer ${
                      selectedColor === col.name
                        ? 'border-[#2563EB] bg-blue-50 dark:bg-blue-950/60 text-[#2563EB] dark:text-blue-400 ring-2 ring-blue-100 dark:ring-blue-900'
                        : 'border-gray-200 dark:border-gray-700 text-[#111827] dark:text-gray-200 hover:border-gray-300 dark:hover:border-gray-600 bg-white dark:bg-gray-800'
                    }`}
                  >
                    <span className="w-3 h-3 rounded-full border border-gray-300 dark:border-gray-600" style={{ backgroundColor: col.hex }} />
                    {col.name}
                  </button>
                ))}
              </div>
          ...
          {selectedProduct.sizes.length > 0 && (
            <div className="space-y-1.5">
              <div className="flex items-center justify-between text-xs font-bold text-[#111827] dark:text-gray-200">
                <span>Size</span>
                <button
          ...
          <div className="space-y-2.5 pt-1">
            <div className="flex items-center gap-3">
              <div className="inline-flex items-center rounded-full border border-gray-200 dark:border-gray-700 p-1 bg-gray-50 dark:bg-gray-800 shrink-0">
                <button
                  onClick={() => setQuantity(Math.max(1, quantity - 1))}
                  className="w-8 h-8 rounded-full bg-white dark:bg-gray-700 shadow-xs text-[#111827] dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600 flex items-center justify-center font-bold text-sm cursor-pointer"
                >
                  -
                </button>
            ...
            <button
              ...
              className="w-full py-3.5 bg-[#111827] dark:bg-blue-600 hover:bg-black dark:hover:bg-blue-700 text-white font-extrabold text-xs sm:text-sm rounded-full shadow-sm transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-98"
            >
          ...
          {/* Short Description */}
          <p className="text-xs text-[#6B7280] dark:text-gray-400 leading-relaxed pt-2 border-t border-gray-100 dark:border-gray-800">
            {selectedProduct.description}
          </p>

          {/* Trust Guarantees */}
          <div className="grid grid-cols-3 gap-2 pt-2 text-center text-[11px] text-[#6B7280] dark:text-gray-400">
            <div className="p-2.5 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-[32px] border border-gray-200/80 dark:border-gray-800 shadow-xs overflow-hidden">
        <div className="flex border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50">
          <button
            ...
            className={`py-4 px-6 text-xs font-bold border-b-2 transition-colors cursor-pointer ${
              activeTab === 'features' ? 'border-[#2563EB] text-[#2563EB] dark:text-blue-400 bg-white dark:bg-gray-900' : 'border-transparent text-[#6B7280] dark:text-gray-400 hover:text-[#111827] dark:hover:text-white'
            }`}
          >
            Product Features
          </button>
          <button
            ...
            className={`py-4 px-6 text-xs font-bold border-b-2 transition-colors cursor-pointer ${
              activeTab === 'specs' ? 'border-[#2563EB] text-[#2563EB] dark:text-blue-400 bg-white dark:bg-gray-900' : 'border-transparent text-[#6B7280] dark:text-gray-400 hover:text-[#111827] dark:hover:text-white'
            }`}
          >
            Specifications
          </button>
          <button
            ...
            className={`py-4 px-6 text-xs font-bold border-b-2 transition-colors cursor-pointer ${
              activeTab === 'delivery' ? 'border-[#2563EB] text-[#2563EB] dark:text-blue-400 bg-white dark:bg-gray-900' : 'border-transparent text-[#6B7280] dark:text-gray-400 hover:text-[#111827] dark:hover:text-white'
            }`}
          >
        ...
        <div className="p-6 sm:p-8">
          {activeTab === 'features' && (
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-[#111827] dark:text-gray-200">
              {selectedProduct.features.map((feat, i) => (
                <li key={i} className="flex items-start gap-2.5 bg-gray-50 dark:bg-gray-800/60 p-3.5 rounded-2xl border border-gray-100 dark:border-gray-700/60">
          ...
          {activeTab === 'specs' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              {Object.entries(selectedProduct.specifications).map(([key, val]) => (
                <div key={key} className="flex justify-between p-3.5 bg-gray-50 dark:bg-gray-800/60 rounded-2xl border border-gray-100 dark:border-gray-700/60">
                  <span className="font-semibold text-[#6B7280] dark:text-gray-400">{key}</span>
          ...
          {activeTab === 'delivery' && (
            <div className="space-y-3 text-xs text-[#6B7280] dark:text-gray-400 leading-relaxed">
              <p>
      ...
      <section id="customer-reviews-section" className="space-y-6 pt-2 scroll-mt-24">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 dark:border-gray-800 pb-4">
          ...
          <div className="flex items-center gap-3 bg-white dark:bg-gray-900 px-4 py-2 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-xs">
            <div className="flex items-center text-amber-400">
              <Star className="w-5 h-5 fill-current" />
            </div>
            <span className="text-lg font-black text-[#111827] dark:text-white">{selectedProduct.rating} out of 5</span>
            <span className="text-xs text-[#6B7280] dark:text-gray-400">Based on {selectedProduct.reviewCount} reviews</span>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {SAMPLE_REVIEWS.map((rev) => (
            <div key={rev.id} className="p-6 bg-white dark:bg-gray-900 rounded-[28px] border border-gray-200/80 dark:border-gray-800 shadow-xs space-y-3">
              ...
              <div className="pt-2 text-[11px] text-[#6B7280] dark:text-gray-400 font-bold flex items-center gap-2">
      ...
      <div className="fixed bottom-0 inset-x-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-t border-gray-200 dark:border-gray-800 p-3 shadow-2xl z-50 sm:hidden flex items-center justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-2 mt-0.5">
            ...
            <span className="text-[10px] text-emerald-600 dark:text-emerald-400 font-bold bg-emerald-50 dark:bg-emerald-950/60 px-1.5 py-0.5 rounded">Free Return</span>
          </div>
        </div>
        <button
          onClick={handleAddToCart}
