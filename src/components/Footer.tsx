      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pt-4">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-lg font-extrabold text-[#111827] dark:text-white tracking-tight">
                Google <span className="text-[#2563EB] dark:text-blue-400">Merch Shop</span>
              </span>
            </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-[#6B7280] dark:text-gray-400">
              ...
              <li><a href="#faq" className="hover:text-[#111827] dark:hover:text-white transition-colors">Merch FAQ & Support</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-gray-100 dark:border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4 text-[11px] text-[#6B7280] dark:text-gray-400">
          ...
          <div className="flex gap-4">
            ...
            <a href="#" className="hover:text-[#111827] dark:hover:text-white">Terms of Service</a>
            <a href="#" className="hover:text-[#111827] dark:hover:text-white">Accessibility</a>
          </div>
        </div>
      </div>
    </footer>
